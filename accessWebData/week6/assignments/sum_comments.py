# -*- coding: utf-8 -*-
"""
Created on Sun Jun 14 20:17:19 2020

@author: Harvey
Instruction: Extracting Data from JSON
    ...
    process for the assignment.
        ...
        Actual data: http://py4e-data.dr-chuck.net/comments_657511.json 
            (Sum ends with 27)
...
json_data = json_handle.read().decode()
json_dict = json.loads(json_data)

total_sum = sum([int(comment['count']) for comment in json_dict['comments']])
print(total_sum)